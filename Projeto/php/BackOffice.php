...
if (isset($_SESSION['username'])) {
    ...
    $query = "SELECT id, Country, Location, Image, id_user, Control FROM guides";
...
//Search bar
    if (isset($_GET['search'])) {
      // Fetch users from the database
      $query = "SELECT id, Username, Country, Image, Location, Control FROM guides";
      $result = mysqli_query($link, $query);
          ...
          <div class = "container-footer">
            <div class = "row-footer">
              <div id = "footer-logo" class = "footer-col" >
                  <ol >
                    <div id = "logo">
                      <a class = "a" href = "../php/HomePageAdmin.php"><img id = "logo1" src = "../img/logo1.png" style = "width: 40%"></a>
