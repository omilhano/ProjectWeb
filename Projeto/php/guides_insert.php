        ...
        if(in_array($fileType, $allowTypes)){ 
            ...
            $imagePath = $uploadDir . $imageName; // Full path of the image in the destination folder
                ...
                if (move_uploaded_file($_FILES["image"]["tmp_name"], $imagePath)) {
                    ...
                    $insert = "INSERT INTO guides (id_user, Description, Date, Location, Num_of_Km, Num_of_cities, Num_of_days, Country, starting_point, way_point, end_point, Image) 
                    VALUES ('".$_SESSION['user_id']."', '$content', '$date', '$location', '$km', '$cities', '$days', '$country', '$startpoint', '$waypoint', '$endpoint', '" . $imageName . "')";
