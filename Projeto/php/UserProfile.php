...
.background-image{
  ...
  background-image: url('../img/profilepage-bg.jpg');
 ...
 <div class="content">
  <div class="main-content">
    ...
    <div class="right-content">
      <img src="../img/hiking.png" id="profile_pic"><br><br>
        ...
        <div class = "container-footer">
          <div class = "row-footer">
            <div id = "footer-logo" class = "footer-col" >
                <ol >
                  <div id = "logo">
                    <a class = "a" href = "../php/HomePageLogIN.php"><img id = "logo1" src = "../img/logo1.png" style="width: 40%;"></a>
